 ...
 */
public class ArticlesByCategoryFragment extends ListArticleFragment<Category>
{
    public static ArticlesByCategoryFragment getInstance(Category category)
    {
        ArticlesByCategoryFragment fragment = new ArticlesByCategoryFragment();
        fragment.setData(category);
        return fragment;
    }
